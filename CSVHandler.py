...
def add_file(file_name):
    ...
    if os.path.exists(Const.CSV_FILES_PATH + f):
        fu.log(fu.get_current_time() + 'File already exists in directory ' + Const.CSV_FILES_PATH +
    ...
    if not fu.has_numeric_columns(Const.CSV_FILES_PATH + f):
    ...
    fu.log(fu.get_current_time() + 'File stored in directory ' + Const.CSV_FILES_PATH + '\n')
    return Const.OK
